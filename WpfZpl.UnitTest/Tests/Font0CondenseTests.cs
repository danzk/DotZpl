...
namespace WpfZpl.UnitTest
{
    ...
    /// on a machine without one of the <see cref="WpfFontManager.FontStack0"/> condensed fonts), the
    /// renderer squeezes it horizontally (<see cref="WpfFontManager.Font0FallbackCondense"/>) to
    ...
    public class Font0CondenseTests
    {
        ...
        {
            var mgr = new WpfFontManager { FontStack0 = new List<string> { "Arial" } };
