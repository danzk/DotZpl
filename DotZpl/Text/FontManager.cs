...
namespace DotZpl.Text
{
    ...
    public class FontManager
    {
        ...
        internal GlyphTypeface GlyphGS => _glyphGs ??= LoadEmbedded("DotZpl.ZplGS.ttf", "DotZpl_ZplGS.ttf", "ZplGS.ttf", "ZPL GS");

        /// <summary>Embedded pixel font matching Zebra Font A (9 x 5 dot matrix).</summary>
        public GlyphTypeface GlyphFontA => _glyphFontA ??= LoadEmbedded("DotZpl.font-a.ttf", "DotZpl_font-a.ttf", "font-a.ttf", "ZPL Font A");

        /// <summary>Embedded pixel font matching Zebra Font B (11 x 7 dot matrix; bold, caps-only).</summary>
        public GlyphTypeface GlyphFontB => _glyphFontB ??= LoadEmbedded("DotZpl.font-b.ttf", "DotZpl_font-b.ttf", "font-b.ttf", "ZPL Font B");

        /// <summary>Embedded pixel font matching Zebra Font C/D (18 x 10 dot matrix).</summary>
        public GlyphTypeface GlyphFontC => _glyphFontC ??= LoadEmbedded("DotZpl.font-c.ttf", "DotZpl_font-c.ttf", "font-c.ttf", "ZPL Font C");
