...
namespace DotZpl.ElementDrawers
{
    ...
    public class FieldBlockElementDrawer : ElementDrawerBase
    {
        ...
        public override Point Draw(ZplElementBase element, DrawerOptions options, Point currentPosition, InternationalFont internationalFont, int printDensityDpmm)
        {
            ...
            double capHeight = TextRenderer.CapHeight(gt, fontSize);
            ...
            foreach (string textLine in textLines)
            {
                ...
                Rect textBounds = TextRenderer.MeasureTightBounds(gt, textLine, fontSize, scaleX);
                ...
                Geometry geometry = TextRenderer.BuildGeometry(
        ...
        {
            double spaceWidth = TextRenderer.MeasureAdvance(gt, " ", emSize, scaleX);
            ...
            while (words.Count != 0)
            {
                ...
                if (word.Contains(@"\&"))
                {
                    ...
                    double wordWidth = TextRenderer.MeasureAdvance(gt, word, emSize, scaleX);
