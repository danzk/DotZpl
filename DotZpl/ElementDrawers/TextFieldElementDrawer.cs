...
namespace DotZpl.ElementDrawers
{
    ...
    public class TextFieldElementDrawer : ElementDrawerBase
    {
        ...
        public override Point Draw(ZplElementBase element, ZplRendererOptions options, Point currentPosition, InternationalFont internationalFont, int printDensityDpmm)
        {
            ...
            double totalWidth = TextRenderer.MeasureAdvance(gt, displayText, fontSize, scaleX);
            Rect tightBounds = TextRenderer.MeasureTightBounds(gt, displayText, fontSize, scaleX);
