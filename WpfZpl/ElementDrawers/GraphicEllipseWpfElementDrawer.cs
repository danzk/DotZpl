...
namespace WpfZpl.ElementDrawers
{
    ...
    /// </summary>
    public class GraphicEllipseWpfElementDrawer : WpfElementDrawerBase
    {
        ...
        public override Point Draw(ZplElementBase element, WpfDrawerOptions options, Point currentPosition, InternationalFont internationalFont)
        {
            ...
            var outer = new EllipseGeometry(center, width / 2.0, height / 2.0);
            ...
            {
                var inner = new EllipseGeometry(center, innerRx, innerRy);
