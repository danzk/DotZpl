...
namespace WpfZpl.ElementDrawers
{
    ...
    /// </summary>
    public class GraphicSymbolWpfElementDrawer : WpfElementDrawerBase
    {
        ...
        public override Point Draw(ZplElementBase element, WpfDrawerOptions options, Point currentPosition, InternationalFont internationalFont, int printDensityDpmm)
        {
            ...
            double totalWidth = WpfTextRenderer.MeasureAdvance(gt, displayText, emSize, scaleX);
            Rect textBounds = WpfTextRenderer.MeasureTightBounds(gt, displayText, emSize, scaleX);
            ...
            Geometry geometry = WpfTextRenderer.BuildGeometryGlyphRun(gt, displayText, emSize, scaleX, new Point(originX, y));
