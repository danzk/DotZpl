    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        private void Analyze()
        {
            ...
            try
            {
                ...
                {
                    new WpfZplElementDrawer(storage, new WpfDrawerOptions { OpaqueBackground = true })
        ...
        private void SavePng()
        {
            ...
            try
            {
                ...
                byte[] png = new WpfZplElementDrawer(storage, new WpfDrawerOptions { OpaqueBackground = true })
